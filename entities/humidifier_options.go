...
type HumidifierOptions struct {
	...
	deviceClass                   string // "The [device class](/integrations/humidifier/#device-class) of the MQTT device. Must be either `humidifier`, `dehumidifier` or `null`."
	...
	modeCommandTemplate           string  // "Defines a [template](/docs/configuration/templating/#using-command-templates-with-mqtt) to generate the payload to send to `mode_command_topic`."
	modeCommandFunc               func(mqtt.Message, mqtt.Client)
	modeStateTemplate             string // "Defines a [template](/docs/configuration/templating/#using-value-templates-with-mqtt) to extract a value for the humidifier `mode` state."
	...
	name                          string     // "The name of the humidifier. Can be set to `null` if only the device name is relevant."
	...
	payloadResetHumidity          string     // "A special payload that resets the `target_humidity` state attribute to an `unknown` state when received at the `target_humidity_state_topic`. When received at `current_humidity_topic` it will reset the current humidity state."
	payloadResetMode              string     // "A special payload that resets the `mode` state attribute to an `unknown` state when received at the `mode_state_topic`."
	platform                      string     // "Must be `humidifier`. Only allowed and required in [MQTT auto discovery device messages](/integrations/mqtt/#device-discovery-payload)."
	...
	targetHumidityStateTemplate   string // "Defines a [template](/docs/configuration/templating/#using-value-templates-with-mqtt) to extract a value for the humidifier `target_humidity` state."
	targetHumidityStateFunc       func() string
	uniqueId                      string // "An ID that uniquely identifies this humidifier. If two humidifiers have the same unique ID, Home Assistant will raise an exception. Required when used with device-based discovery."
}
...
func (o *HumidifierOptions) ActionTemplate(template string) *HumidifierOptions {
	o.actionTemplate = template
	return o
}
func (o *HumidifierOptions) ActionFunc(f func() string) *HumidifierOptions {
	o.actionFunc = f
	return o
}
...
func (o *HumidifierOptions) CurrentHumidityTemplate(template string) *HumidifierOptions {
	o.currentHumidityTemplate = template
	return o
}
func (o *HumidifierOptions) CurrentHumidityFunc(f func() string) *HumidifierOptions {
...
func (o *HumidifierOptions) EntityPicture(picture string) *HumidifierOptions {
...
func (o *HumidifierOptions) MaxHumidity(humidity float64) *HumidifierOptions {
	o.maxHumidity = humidity
	return o
}
func (o *HumidifierOptions) MinHumidity(humidity float64) *HumidifierOptions {
...
func (o *HumidifierOptions) Platform(platform string) *HumidifierOptions {
	o.platform = platform
	return o
}
