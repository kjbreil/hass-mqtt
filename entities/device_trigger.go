...
type DeviceTrigger struct {
	...
	Platform       *string `json:"platform,omitempty"`        // "Must be `device_automation`. Only allowed and required in [MQTT auto discovery device messages](/integrations/mqtt/#device-discovery-payload)."
