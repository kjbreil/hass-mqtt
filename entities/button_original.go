...
func (d *ButtonOriginal) GetRawId() string {
	return "button"
}
func (d *ButtonOriginal) AddMessageHandler() {
	d.MQTT.MessageHandler = MakeMessageHandler(d)
}
func (d *ButtonOriginal) GetUniqueId() string {
	return *d.UniqueId
}
func (d *ButtonOriginal) GetName() string {
	return *d.Name
}
func (d *ButtonOriginal) PopulateDevice(Manufacturer string, SoftwareName string, InstanceName string, SWVersion string, Identifier string) {
...
func (d *ButtonOriginal) UpdateState() {
...
func (d *ButtonOriginal) Subscribe() {
	c := *d.MQTT.Client
...
func (d *ButtonOriginal) UnSubscribe() {
	c := *d.MQTT.Client
...
func (d *ButtonOriginal) AnnounceAvailable() {
	c := *d.MQTT.Client
	token := c.Publish(*d.AvailabilityTopic, common.QoS, common.Retain, "online")
	token.WaitTimeout(common.WaitTimeout)
}
func (d *ButtonOriginal) Initialize() {
	if d.Qos == nil {
		d.Qos = new(int)
...
func (d *ButtonOriginal) DeleteTopic() {
	c := *d.MQTT.Client
	token := c.Publish(GetDiscoveryTopic(d), 0, true, "")
	token.WaitTimeout(common.WaitTimeout)
	time.Sleep(common.HADiscoveryDelay)
}
func (d *ButtonOriginal) PopulateTopics() {
	if d.AvailabilityFunc != nil {
...
func (d *ButtonOriginal) SetMQTTFields(fields MQTTFields) {
	*d.MQTT = fields
}
func (d *ButtonOriginal) GetMQTTFields() (fields MQTTFields) {
	return *d.MQTT
}
